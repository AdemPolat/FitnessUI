...
public class FitnessPictureViewHolder extends RecyclerView.ViewHolder {
    ...
    public FitnessPictureViewHolder(@NonNull View itemView) {
        ...
        imageView = itemView.findViewById(R.id.recyclerview_fitness_list_imageview);
        progressBar= itemView.findViewById(R.id.recyclerview_fitness_picture_list_progressbar);
